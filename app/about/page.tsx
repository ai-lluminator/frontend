          ...
          <div className="flex flex-wrap -mx-3 items-stretch">
              ...
              <div className="rounded overflow-hidden shadow-lg p-6 flex flex-col">
                ...
                <div className="text-blue-600 flex gap-2 flex-wrap">
                  <div className="text-right mt-2">
                    <a href="mailto:cornelius@ailluminator.com" className="text-blue-600 hover:text-blue-800">Mail contact</a>
                  </div>
                  <div className="flex flex-wrap mt-2">
                    <a href="https://github.com/cowolff">GitHub</a>
                  </div>
                  <div className="text-right mt-2">
                    <a href="https://www.linkedin.com/in/co-wolff/">LinkedIn</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 px-3 mb-6">
              <div className="rounded overflow-hidden shadow-lg p-6 flex flex-col">
                ...
                <div className="text-blue-600 flex gap-2 flex-wrap">
                  <div className="text-right mt-2">
                    <a href="mailto:tom@ailluminator.com" className="text-blue-600 hover:text-blue-800">Mail contact</a>
                  </div>
                  <div className="flex flex-wrap mt-2">
                    <a href="https://github.com/tomhaerter">GitHub</a>
                  </div>
                  <div className="text-right mt-2">
                    <a href="https://www.linkedin.com/in/tomhaerter/">LinkedIn</a>
                  </div>
                </div>
              </div>
            </div>
